...
"#,
            method = match api.method {
                crate::schema::HttpMethod::Get => "Get",
                crate::schema::HttpMethod::Post => "Post",
                crate::schema::HttpMethod::Put => "Put",
                crate::schema::HttpMethod::Patch => "Patch",
                crate::schema::HttpMethod::Delete => "Delete",
            },
